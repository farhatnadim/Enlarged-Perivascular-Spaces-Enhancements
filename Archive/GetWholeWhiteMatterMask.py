...
import os
import numpy as np
base_dir = "/mnt/d/PhD_Data/MSBRAIN/"
subject = 'MH429'
...
segmentation_file = 'T1w-MP2RAGE-0p55_UNI-DEN_390x300.18_synthseg_resampled.nii.gz'
segementation_file_full_path = os.path.join(base_dir, Brain_seg_dir,subject,segmentation_file)
segmentation_image = itk.imread(segementation_file_full_path)
...
masked_mri_image = itk.image_from_array(mri_array.astype(np.uint16)) 
